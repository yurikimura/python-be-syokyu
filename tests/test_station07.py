...
def test_put_todo_list(db_session) -> None:
    """Station07合格判定テストコード."""
    db_item = list_model.ListModel(title="station07_test", description="A test record for station07.")
    ...
    response = client.put(f"/lists/{db_item.id}", json={
        ...
        "description": "This todo was modified by the test of Station07.",
    })
    ...
    assert response_body["description"] == "This todo was modified by the test of Station07."
